...
{ 
    ...
    <script type="text/javascript">
        jQuery(function()
        {
            var message = '<p>'.printf( __( '<strong>激活成功!</strong> 主题设置请到 <a href="%s">主题选项</a>中设置，感谢您对<a href="https://salongweb.com" title="萨龙网络｜专注Wordpress主题设计与开发！">萨龙网络</a>的支持！' , 'salong' ), esc_attr(admin_url('admin.php?page=_options&tab=0'))).'</p>';
        ...
        class ReduxFramework {
                    ...
                    if ( $this->args['async_typography'] && ! empty ( $this->typography ) ) {
                        ...
                        <script>
                            ...
                            (function() {
                                ...
                                wf.src = ReduxFramework::$_url . 'assets/js/webfont.js';
            ...
            public function section_menu( $k, $section, $suffix = "", $sections = array() ) {
                ...
                if ( isset ( $section['type'] ) && $section['type'] == "divide" ) {
                    ...
                    $extra_icon = $subsections ? '<span class="extraIconSubsections"><i class="dashicons-arrow-down-alt2">&nbsp;</i></span>' : '';
