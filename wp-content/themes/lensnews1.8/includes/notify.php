...
function add_checkbox() {
  echo '<input type="checkbox" name="comment_mail_notify" id="comment_mail_notify" value="comment_mail_notify" checked="checked" style="margin-left:0px;" /><label id="comment_mail_title" for="comment_mail_notify">有人回复时邮件通知我</label>';
}
