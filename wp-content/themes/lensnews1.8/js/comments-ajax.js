...
while ( i <= len && got == -1){
	var js_url = document.getElementsByTagName('script')[i].src,
			got = js_url.indexOf('js/comments-ajax.js'); i++ ;
}
var edit_mode = '1', // 再編輯模式 ( '1'=開; '0'=不開 )
		ajax_php_url = js_url.replace('comments-ajax.js','comments-ajax.php'),
		...
		edt2 = ')\'><i class="icon-edit-1"></i>重新编辑</a></div> ',
		cancel_edit = '取消编辑',
...
// show comment
		...
		new_htm = ( parent == '0' ) ? ('\n<ol style="clear:both;" class="commentlist box' + new_htm + 'ol>') : ('\n<ul class="children' + new_htm + 'ul>');
